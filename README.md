...
const sandesh = {
    ...
    currentFocus: "Translating complex data into actionable business strategies",
    lifePhilosophy: "Analyze with insight, communicate with logic, solve with empathy",
